        ...
        <div class="card card-group-row__card pricing__card">
            ...
            <div class="card-body d-flex flex-column">
                ...
                <div class="card-body mt-0 mb-0 pb-0">
                    <div class="row">
                        <div class="col-sm-4">
                            <a href="/painel/galeria/alterar?id=" class="btn btn-primary"><i class="material-icons">create</i></a>
                        </div>
                        <div class="col-sm-4">
                            <a href="/painel/galeria/visualizar?id=" class="btn btn-secondary"><i class="material-icons">visibility</i></a>
                        </div>
                        <div class="col-sm-4">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Você tem certeza que deseja remover o álbum <b>Nome do álbum</b>?</p>
            </div>
