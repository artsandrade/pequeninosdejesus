		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 col-md-12 col-lg-4">
					<h2 class="section-heading text-center mb-5">Missão</h2>
					<p class="text-justify">Oferecer educação moral e intelectual, visando qualidade de vida, proporcionando uma visão de mundo que assegure condições de viver em uma sociedade eficaz, num ambiente participativo e criativo, de respeito ao próximo; bem como orientação e apoio à família, fortalecendo os vínculos familiares.</p>
				</div>
				<div class="col-sm-12 col-md-12 col-lg-4">
					<h2 class="section-heading text-center mb-5">Visão</h2>
					<p class="text-justify">Ser um espaço privilegiado para a construção individual e coletiva das competências necessárias ao pleno exercício da cidadania.</p>
				</div>
				<div class="col-sm-12 col-md-12 col-lg-4">
					<h2 class="section-heading text-center mb-5">Filosofia</h2>
					<p class="text-justify">A filosofia do Instituto Educacional Pequeninos de Jesus é a Educação Integral que contempla todas as dimensões do indivíduo: social, cultural, histórica, psicológica, física, emocional, familiar, entre outras, integrando a educação a tudo o que ocorre no entorno do educando: família, educadores, gestores e comunidade local.</p>
				</div>
			</div>
		</div>
	</div>
